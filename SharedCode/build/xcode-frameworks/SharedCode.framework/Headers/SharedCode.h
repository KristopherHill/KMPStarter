...
@interface SharedCodeUser : SharedCodeBase
- (instancetype)initWithFirstName:(NSString *)firstName lastName:(NSString *)lastName address:(NSString *)address phoneNumber:(NSString *)phoneNumber age:(int32_t)age __attribute__((swift_name("init(firstName:lastName:address:phoneNumber:age:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (int32_t)component5 __attribute__((swift_name("component5()")));
- (SharedCodeUser *)doCopyFirstName:(NSString *)firstName lastName:(NSString *)lastName address:(NSString *)address phoneNumber:(NSString *)phoneNumber age:(int32_t)age __attribute__((swift_name("doCopy(firstName:lastName:address:phoneNumber:age:)")));
...
@property (readonly) NSString *fullDetails __attribute__((swift_name("fullDetails")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PlatformIdKt")))
@interface SharedCodePlatformIdKt : SharedCodeBase
